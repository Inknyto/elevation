...
const LetterComponent = ({ onSendLetter, onRemoveLetterDiv }) => {
  ...
  const generateCoverLetter = async () => {
    ...
    const prompt = `Write a cover letter from ${letterFormData.from} to ${letterFormData.to} with the subject "${letterFormData.subject}". ${letterFormData.body}`;
