...
// 
  ...
  const CardComponent = ({ Nom, Type, Region, Arrondissement, Commune, Tél, onCloseClick }) => {
	  // 'Nom', 'Type', 'Region', 'Arrondissement', 'Commune', 'Quartier', 'Tél', 'Statut ligne'
    return (
      <div className="modal">
        <Card variant="outlined" className="job-card">
          <CardContent>
            <CardHeader Nom={Nom} subheader={Nom} />

            <Typography component="span" >
              <Typography component="span" variant="body2" color="textSecondary">
                <strong> Secteur d'activité: </strong> {Type}<br />
